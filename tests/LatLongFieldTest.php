...
class LatLongFieldTest extends SapphireTest
{
     ...
     * null like any other invalid coordinate (see the changelog). Pinned separately because the
     * "garbage" cases above never produced a distance, so they cannot catch a lenient parser.
     * 1.0.6 gave: trailing text 340.64, a third part 318.21, decimal commas 95.29, a float 67.21.
     */
